 ...
 * Time: 6:21 PM
 */
public class CategoryNameImpl extends CommonIdentifierImpl implements CategoryName, Serializable {
    private static final long serialVersionUID = Const.DEFAULT_SERIAL_VERSION;

    public CategoryNameImpl(final String value) {
        super(value);

    }

    protected CategoryNameImpl() {
        super();
    }
}
