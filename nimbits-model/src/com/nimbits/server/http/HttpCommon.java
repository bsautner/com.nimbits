...
public interface HttpCommon {
    ...
    String doGet(final String postUrl, final String params, final String authCookie) throws NimbitsException;

    String doPost(final String postUrl, final String params, final String authCookie) throws NimbitsException;
