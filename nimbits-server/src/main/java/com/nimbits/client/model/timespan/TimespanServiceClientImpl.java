...
public class TimespanServiceClientImpl {
    ...
    public static Timespan createTimespan(final String start, final String end)  {
...
//    }
    ...
    private static Timespan interpretTimespan(final String startSample, final String endSample)  {
        ...
        if (start == null || end == null) {
            throw new IllegalArgumentException("Problem parsing date");
        } else if (start.getTime() >= end.getTime()) {
            throw new IllegalArgumentException("Start time was more recent than end time");
