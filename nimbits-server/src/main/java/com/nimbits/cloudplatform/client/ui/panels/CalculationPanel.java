...
//    }
    ...
    private class AddCalcEntityAsyncCallback implements AsyncCallback<List<Entity>> {
    ...
    private class SubmitButtonEventSelectionListener extends SelectionListener<ButtonEvent> {
        ...
        public void componentSelected(ButtonEvent buttonEvent) {
            ...
            service.addUpdateEntityRpc(Arrays.<Entity>asList(update), new AddCalcEntityAsyncCallback(box));
