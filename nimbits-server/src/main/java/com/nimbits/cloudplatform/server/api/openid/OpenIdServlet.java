...
public class OpenIdServlet extends HttpServlet {
   ...
   // protected ConsumerHelper consumerHelper;
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
         ...
         resp.sendRedirect("https://cloud.nimbits.com");
...
//        }
     ...
     * @throws javax.servlet.ServletException if unable to process request
     * @throws java.io.IOException if unable to process request
     */
    @Override
    ...
    AuthRequest startAuthentication(String op, HttpServletRequest request)
        ...
        AuthRequestHelper helper = null;//consumerHelper.getAuthRequestHelper(openId,
               // returnToUrl);
    ...
    UserInfo completeAuthentication(HttpServletRequest request)
        ...
        AuthResponseHelper authResponse = null;//consumerHelper.verify(receivingUrl,
