...
public interface EntityDao {
    ...
    List<Entity> getEntitiesBySource(User user, Entity source, Class<?> cls) throws Exception;

    List<Entity> getEntityByKey(User user, String uuid, Class<?> cls);
    ...
    Map<String, Entity> getSystemWideEntityMap(User admin, EntityType type) throws Exception;
}
