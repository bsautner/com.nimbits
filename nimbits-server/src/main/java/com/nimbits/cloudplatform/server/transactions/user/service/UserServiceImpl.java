...
public class UserServiceImpl implements UserService {
    ...
    public UserServiceImpl() {
        ...
        userCache = com.nimbits.cloudplatform.server.transactions.user.UserServiceFactory.getCacheInstance();
    }
    ...
    public User getAdmin()   {
        final String adminStr = SettingFactory.getServiceInstance().getSetting(SettingType.admin.getName());
