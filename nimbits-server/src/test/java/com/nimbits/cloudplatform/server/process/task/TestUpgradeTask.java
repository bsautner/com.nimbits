...
//        for (User u : users) {
//            Map<String, Entity> cmap = EntityServiceImpl.getEntityMap(u, EntityType.category, 1000);
//            Map<String, Entity> pmap = EntityServiceImpl.getEntityMap(u, EntityType.point, 1000);
...
//    @Test
//    public void doUserTest() , InterruptedException {
//        final PersistenceManager pm = PMF.get().getPersistenceManager();
//
//        UserEntity u;
//        for (int i = 0; i < 100; i++) {
...
//        Thread.sleep(1000);
//        final Entity userEntity = EntityServiceImpl.getEntityByName(CommonFactory.createName(("test@example.com"), EntityType.user));
//        for (int x = 0; x < 10; x++) {
//            PointCatagory c = new PointCatagory();
//            c.name = UUID.randomUUID().toString();
//            c.userFK = user.getId();
...
//
//
//        List<Entity> categories = EntityServiceImpl.getChildren(userEntity, EntityType.category);
