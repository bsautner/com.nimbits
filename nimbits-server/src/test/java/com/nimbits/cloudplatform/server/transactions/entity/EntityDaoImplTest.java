...
public class EntityDaoImplTest extends NimbitsServletTest {
    ...
    public void addUpdateEntityTest() throws Exception {
        ...
        Entity result = EntityServiceImpl.addUpdateEntity(user, add).get(0);
        ...
        Point point1 = PointModelFactory.createPointModel(
                ...
                false,
                PointType.basic, 0, false, 0.0);
        Point px = (Point) EntityServiceImpl.addUpdateSingleEntity(point1);
    ...
    public void addUpdateAlertsEntityTest3() throws Exception {
        ...
        EntityDao.addUpdateEntity(user, Arrays.<Entity>asList(rp));
    ...
    public void deleteEntityTest() throws Exception {
        ...
        final Entity result = EntityServiceImpl.addUpdateEntity(user, Arrays.<Entity>asList(point1)).get(0);
        //Entity result = EntityDao.addUpdateSingleEntity(entity);
    ...
    public void testValidation() throws Exception {
        ...
        EntityDao.addUpdateEntity(user, Arrays.<Entity>asList(e));
