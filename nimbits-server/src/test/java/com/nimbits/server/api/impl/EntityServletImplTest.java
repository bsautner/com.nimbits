...
public class EntityServletImplTest extends NimbitsServletTest {
    ...
    @Test
    public void testUpdatePoint() throws IOException, ServletException, Exception {
        req.removeAllParameters();
    ...
    public void testUpdatePointWithFragment() throws IOException, ServletException, Exception {
        req.removeAllParameters();
    ...
    @Test
    public void testSubscribe() throws IOException, ServletException, Exception {
    ...
    @Test
    public void testUpdate() throws IOException, ServletException, Exception {
        ...
        entityServlet.doGet(req1, resp1);
