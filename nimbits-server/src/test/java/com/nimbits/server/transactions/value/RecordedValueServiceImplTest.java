...
public class RecordedValueServiceImplTest extends NimbitsServletTest {
    ...
    public void ignoreByCompressionTest() throws Exception {
        ...
        valueService.recordValue(req, user, point, value);
        ...
        valueService.recordValue(req, user, point, ValueFactory.createValueModel(100));
        Thread.sleep(10);
    ...
    public void ignoreByCompressionTest2() throws Exception {
        ...
        valueService.recordValue(req, user, randomPoint, value);
        assertTrue(valueService.ignoreByFilter(randomPoint, value2));
        Thread.sleep(100);
        valueService.recordValue(req, user, randomPoint, value2);
        Thread.sleep(100);
        valueService.recordValue(req, user, randomPoint, value3);
        Thread.sleep(100);
