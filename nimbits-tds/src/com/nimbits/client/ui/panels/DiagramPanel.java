...
public class DiagramPanel extends LayoutContainer {
    ...
    public DiagramPanel(final User user, final File aDiagram, boolean showHeader) {
    ...
    private void applyValueToTextNode(final List<Value> result, final EntityName pointName, final String[] actions, final OMSVGTextElement o) throws NimbitsException {
        if (pointEntityMap != null && pointEntityMap.containsKey(pointName)) {
            ...
            if (result != null) {
                ...
                EntityServiceAsync service = GWT.create(EntityService.class);
                service.getEntityByKey(user, entity.getKey(), EntityType.point,  new AsyncCallback<List<Entity>>() {
