...
public class ValueTransactionFactory {
    ...
    private ValueTransactionFactory() {
    }

    public static ValueTransactions getInstance(final Entity point) {

        return new ValueMemCacheImpl(point);

    }

    public static ValueTransactions getDaoInstance(final Entity point) {
