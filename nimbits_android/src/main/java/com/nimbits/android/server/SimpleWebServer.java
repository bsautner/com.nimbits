...
public class SimpleWebServer extends NanoHTTPD {
    ...
    Response serveFile(String uri, Map<String, String> header, File homeDir) {
        ...
        if (!homeDir.isDirectory()) {
            res = new Response(Response.Status.INTERNAL_ERROR, MIME_PLAINTEXT, "INTERNAL ERRROR: serveFile(): given homeDir is not a directory.");
        }
        ...
        if (res == null) {
            ...
            if (uri.startsWith("src/main") || uri.endsWith("src/main") || uri.contains("../"))
                res = new Response(Response.Status.FORBIDDEN, MIME_PLAINTEXT, "FORBIDDEN: Won't serve ../ for security reasons.");
        }

        File f = new File(homeDir, uri);
        if (res == null && !f.exists()) {
            res = new Response(Response.Status.NOT_FOUND, MIME_PLAINTEXT, "Error 404, file not found.");
        }
        ...
        if (res == null && f.isDirectory()) {
            ...
            if (!uri.endsWith("/")) {
                uri += "/";
                res = new Response(Response.Status.REDIRECT, MIME_HTML, "<html><body>Redirected: <a href=\"" + uri + "\">" + uri
                        + "</a></body></html>");
            ...
            if (res == null) {
                ...
                if (new File(f, "index.html").exists()) {
                    ...
                    res = new Response(Response.Status.FORBIDDEN, MIME_PLAINTEXT, "FORBIDDEN: No directory listing.");
                }
            }
        }
