package com.nimbits.cloudplatform.chart;
...
public class SeriesChart extends AbstractChart {
     ...
     */
    public View execute(Context context, Point entity, List<Value> valuesResponse) throws Exception {
        ...
        setChartSettings(renderer, "", "", entity.getUnit(), start, end, -5, 30, Color.LTGRAY, Color.LTGRAY);
