...
public interface UserServiceRpc extends RemoteService {
    ...
    User register(final String email, final String password, final String pendingConnectionToken) throws UserServiceRpcException;
    ...
    Boolean processConnection(String email, String token) throws UserServiceRpcException;
