...
public interface UserServiceRpcAsync {
    ...
    void register(final String email, final String password, String pendingConnection, final AsyncCallback<User> async) throws UserServiceRpcException;
    ...
    void processConnection(String email, String token, AsyncCallback<Boolean> asyncCallback) throws UserServiceRpcException;
