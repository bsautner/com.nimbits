...
public class EntityContextMenu extends Menu implements BasePanel.PanelEvent {
    ...
    private MenuItem connectionContext;
    ...
    private class ConnectionMenuEventSelectionListener extends SelectionListener<MenuEvent> {
        ConnectionMenuEventSelectionListener() {
        }
    ...
    private MenuItem connectionContext() {
        ...
        retObj.setText(CONNECT_USER_ACCOUNTS);
        retObj.setIcon((Icons.INSTANCE.connection()));
        retObj.addSelectionListener(new ConnectionMenuEventSelectionListener());
        return retObj;
    }
    ...
    public void showConnectionPanel(final Entity entity) {
        panel = new ConnectionPanel(this, entity);
        showModal(panel, CONNECT_ACCOUNTS);
    ...
    public void showSyncPanel(final Entity entity) {
