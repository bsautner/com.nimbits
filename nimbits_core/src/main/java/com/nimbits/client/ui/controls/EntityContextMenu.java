...
//    }
    ...
    public void showKeyPanel(final Entity entity) {
        ...
        w.setWidth(WIDTH);
        w.setHeight(HEIGHT);
         w.setHeadingText("Read/Write Key");
        w.add(dp);
    ...
    public void showSubscriptionPanel(final Entity entity) {
        ...
        w.setWidth(WIDTH);
        w.setHeight(HEIGHT);
       w.setHeadingText(SUBSCRIBE_TO_EVENTS);
        w.add(dp);
    ...
    public void showCalcPanel(final Entity entity)  {
        ...
        if (entity.getEntityType().equals(EntityType.point)) {
           w.setHeadingText("Calculations triggered when data is recorded to " + entity.getName().getValue());
        }
        else {
           w.setHeadingText(TEXT);
    ...
    private class EditMenuEventSelectionListener extends SelectionListener<MenuEvent> {
        ...
        private void createPointPropertyWindow(final Entity entity)  {
            ...
            window.setHeadingText(entity.getName().getValue() + " Properties");
