...
public abstract class EntityStore implements Entity {
    ...
    public EntityStore(final Class<?> cls, final Entity entity)  {
...
//                ? createKey(cls.getSimpleName(), saferName.getValue())
//                : entity.getEntityType().equals(EntityType.point)
//                ? createKey(cls.getSimpleName(), entity.getOwner() + '/' + saferName.getValue())
//                : createKey(cls.getSimpleName(), UUID.randomUUID().toString()) : createKey(cls.getSimpleName(), entity.getKey());
//        this.key = saferName.getValue();
    }
...
//    }
    ...
    public void validate(User user) {
        ...
        if (! this.owner.equals(user.getKey()) && ! entityType.equals(EntityType.user.getCode())) {
