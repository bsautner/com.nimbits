...
public class SubscriptionServiceFactory {
    ...
    public static SubscriptionService getServiceInstance(NimbitsEngine engine, TaskService taskService) {
        return new SubscriptionServiceImpl(engine, taskService);
    }
}
