...
public final class Datastore {
    ...
    private static final String DEVICE_OWNER_PROPERTY = "owner";
     ...
     * @param email
     */
    public static void register(String regId, String email) {
        ...
        try {
            ...
            entity.setProperty(DEVICE_OWNER_PROPERTY, email);
     ...
     */
    public static List<String> getDevices(String email) {
        List<String> devices;
        Transaction txn = datastore.beginTransaction();
        try {

            Query query = new Query(DEVICE_TYPE).addFilter(DEVICE_OWNER_PROPERTY, FilterOperator.EQUAL, email);
     ...
     */
    public static String createMulticast(List<String> devices, String email) {
