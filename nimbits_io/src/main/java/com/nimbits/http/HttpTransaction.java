...
public class HttpTransaction {
    ...
    public <T, K> List<T> doGet(final Class<K> clz,
        ...
        try {
            ...
            HttpResponse response = HttpClientFactory.getInstance(apiKey).execute(http);
...
//            http.abort();
            HttpClientFactory.getInstance(apiKey).getConnectionManager().closeExpiredConnections();
        }
