...
public class SocketDeserializer implements JsonDeserializer<Socket> {
    @Override
    public Socket deserialize(final JsonElement jsonElement, final Type type, final JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
