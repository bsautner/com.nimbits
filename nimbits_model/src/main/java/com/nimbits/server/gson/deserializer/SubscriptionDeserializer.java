...
public class SubscriptionDeserializer implements JsonDeserializer<Subscription> {
    @Override
    public Subscription deserialize(final JsonElement jsonElement, final Type type, final JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
