...
public class SummaryDeserializer implements JsonDeserializer<Summary> {
    @Override
    public Summary deserialize(final JsonElement jsonElement, final Type type, final JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
