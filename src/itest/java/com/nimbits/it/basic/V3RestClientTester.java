...
public class V3RestClientTester extends AbstractNimbitsTest {
    ...
    @Test @Ignore //TODO Equals Problem with value
    ...
    private void createPoints() {
        ...
        for (int i = 0; i < 10; i++) {
            Topic topic = new Topic.Builder().name(UUID.randomUUID().toString()).parent(user.getId())
                    .create();
    ...
    /**
     * Record large amounts of data to each topic
     */
